    ...
    <div className="space-y-6">
      ...
      {tab === 'receipts' && (
        <Panel>
            <div className="table-wrap">
            <table className="data-table text-sm">
              <thead><tr><th>رقم</th><th>{t('common.customer')}</th><th>{t('common.currency')}</th><th>مبلغ</th><th>{t('common.status')}</th><th></th></tr></thead>
              <tbody>
